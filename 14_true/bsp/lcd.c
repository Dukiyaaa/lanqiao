...
extern float fre, duty;
extern float r37_val;
extern bool reset;
extern uint32_t FH_raw, TH_raw;
extern float AH_raw;
extern uint32_t FP_raw, TT_raw;
extern float VP_raw;
void lcd_task(void)
{	
	switch(lcd_num)
...
//		LCD_DisplayStringLine(Line7, (unsigned char *)lcd_text);
		...
		sprintf(lcd_text, "     FN=%d           ", FN);
		LCD_DisplayStringLine(Line3, (unsigned char *)lcd_text);
		sprintf(lcd_text, "     AN=%d           ", AN);
		LCD_DisplayStringLine(Line4, (unsigned char *)lcd_text);
		sprintf(lcd_text, "     TN=%d           ", TN);
		LCD_DisplayStringLine(Line5, (unsigned char *)lcd_text);
		sprintf(lcd_text, "                    ");
		LCD_DisplayStringLine(Line6, (unsigned char *)lcd_text);
		break;
		case 3:
		LCD_DisplayStringLine(Line1, (unsigned char *)"        FSET        ");	
		sprintf(lcd_text, "     FP=%d           ", FP_raw);
		LCD_DisplayStringLine(Line3, (unsigned char *)lcd_text);
		sprintf(lcd_text, "     VP=%.1f           ", VP_raw);
		LCD_DisplayStringLine(Line4, (unsigned char *)lcd_text);
		sprintf(lcd_text, "     TT=%d           ", TT_raw);
		LCD_DisplayStringLine(Line5, (unsigned char *)lcd_text);
		sprintf(lcd_text, "                    ");
		LCD_DisplayStringLine(Line6, (unsigned char *)lcd_text);
		break;
